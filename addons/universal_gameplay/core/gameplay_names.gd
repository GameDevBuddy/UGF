...
const EVENT_LEVEL_GAINED: StringName = &"level_gained"
const EVENT_SKILL_UNLOCKED: StringName = &"skill_unlocked"
...
const MODULE_LOOT: StringName = &"module.loot"
const MODULE_GATHERING: StringName = &"module.gathering"
...
const MODULE_PROGRESSION: StringName = &"module.progression"
